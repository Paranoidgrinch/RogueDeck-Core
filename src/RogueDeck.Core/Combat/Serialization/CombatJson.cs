...
public static class CombatJson
{
    ...
    private static void RegisterExpressions(CombatJsonRegistry r)
    {
        ...
        r.Register("const", typeof(ConstantExpression<>))
         ...
         .Register("cardPlaysThisCombat", typeof(CardPlaysThisCombatExpression<>))
         .Register("announcedRuleIs", typeof(AnnouncedRuleIsExpression<>))
    ...
    private static void RegisterNodes(CombatJsonRegistry r)
    {
        r.Register("node.resolveQueuedCards", typeof(ResolveQueuedCardsNode<>))
         ...
         .Register("node.applyTriggerEventStatus", typeof(ApplyTriggerEventStatusNode<>))
         ...
         .Register("node.announceRule", typeof(AnnounceRuleNode<>))
