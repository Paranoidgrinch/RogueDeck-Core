    ...
    private static void AddCustomStatuses(SandboxModel model, ScenarioBlueprint blueprint)
    {
        foreach (var status in model.Statuses)
        {
            ...
            if (status.PreventsDeath)
                blueprint.PreDownInterceptors.Add(StatusDataRebuild.RebuildDeathPrevention(slug,
            ...
            if (status.BlocksDebuffs)
                blueprint.StatusApplicationInterceptors.Add(StatusDataRebuild.RebuildDebuffBlock(slug,
