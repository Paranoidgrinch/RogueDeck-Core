...
public static class CombatProgramModel
{
        ...
        where TContext : class
    {
        ...
        return spec.Kind switch
        {
            ...
            "cardDrawsThisTurn" => new CardDrawsThisTurnExpression<TContext>(SelectorFor(spec.SelectorKey)),
    ...
    public static CombatAmountSpec ClassifyAmount<TContext>(ICombatExpression<TContext, int> amount)
        ...
        amount switch
        {
            ...
            CardDrawsThisTurnExpression<TContext> e => StateReadAmount("cardDrawsThisTurn", e.Selector),
